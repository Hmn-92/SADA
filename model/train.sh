...
#python main.py --gpu_devices 0 --dataset prcc --dataset_root data --dataset_filename prcc  --save_dir log/eps_0.6/prcc --save_checkpoint --eps 0.6 --max_epoch 80 --fg_start_epoch 20