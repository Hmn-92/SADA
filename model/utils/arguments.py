...
def get_args():
    ...
    # Data
    parser.add_argument('-d', '--dataset', type=str, default='prcc')
    parser.add_argument('--dataset_root', type=str, default='data', help="root path to data directory")
    parser.add_argument('--dataset_filename', type=str, default='prcc')
    ...
    # parser.add_argument('--save_checkpoint', default=True, help='save model checkpoint')


    parser.add_argument('--fg_start_epoch', type=int, default=1,
